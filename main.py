...
async def main(phone) -> None:
    async with client:
        ...
        check_script(processed_chats, "temp_var/processed_chats.pickle")
        ...
        iteration_num = 1
        check_script(iteration_num, "temp_var/iteration_num.pickle")
        ...
        while time.time() < end_time:
            ...
            # Check if the script run before
            check_script(full_iteration, "temp_var/full_iteration.pickle")
            check_script(all_mentions, "temp_var/all_mentions.pickle")
