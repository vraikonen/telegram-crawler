...
- [ ] Updating database with new messages - a lot to discuss (or a lot for me to consider)
...
- [ ] Should we differentiate between mentioned chats, linked chats and fwds in chat network?
...
Potential upgrades (not checked):
- [ ] Generally go and check all possible endpoints!
- [ ] Filter messages on the go for some project https://core.telegram.org/method/messages.search
- [ ] Search specific messages globally https://core.telegram.org/method/messages.searchGlobal
- [ ] Get live location history of a certain user messages.getRecentLocations
- [ ] Is this better way to check linked_chat_id https://core.telegram.org/method/channels.getGroupsForDiscussion
<p align="right">(<a href="#readme-top">back to top</a>)</p>

<!-- Roadmap -->
## Roadmap (mainly for me)
- [ ] Check messages.channelMessages difference to messages.messages from GetHistoryRequest, I think messages.messsages is  good for channels also
...
- [ ] CHECK NAMING< HOW TO CALL DIFFERENT SUBOBJECTS FFS
- [ ] CHECK HASH AND PAGINATION
- [ ] https://core.telegram.org/constructor/messages.messages check here list of chats mentioned in dialogs? is good for network?
- [ ] is this good for network https://core.telegram.org/method/stats.getMessagePublicForwards
- [ ] is this better way to check linked id https://core.telegram.org/method/channels.getGroupsForDiscussion 
